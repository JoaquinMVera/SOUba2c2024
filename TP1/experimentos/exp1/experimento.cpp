...
const string ARCHIVO_LECTURA = "../../data/corpus.txt";
const string ARCHIVO_TESTER = "./corpusTester.txt";
...
double realizarExperimentosConCantThreads(int threads) {
    ...
    vector<string> filePath = {ARCHIVO_LECTURA};
        ...
        //Usamos el promedio de las duraciones, porque es una medida mas verosimil y real
...
int main(int argc, char* argv[]) {
    ...
    // Creamos el archivo para los resultados
